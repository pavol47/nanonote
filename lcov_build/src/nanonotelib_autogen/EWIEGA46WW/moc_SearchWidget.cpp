...
QT_MOC_LITERAL(1, 13, 17), // "closeSearchDialog"
QT_MOC_LITERAL(2, 31, 0) // ""

    },
    "SearchWidget\0closeSearchDialog\0"
};
...
void SearchWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->closeSearchDialog(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SearchWidget::closeSearchDialog)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SearchWidget::closeSearchDialog()
{
